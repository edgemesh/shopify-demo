...
class CartIcon extends Component {
  ...
  renderCartBubble = async (itemCount, animate = true) => {
    const showEmptyBubble = Boolean(this.closest('[data-em-cart-fragment]'));
    this.refs.cartBubbleCount.classList.toggle('hidden', itemCount === 0 && !showEmptyBubble);
    this.refs.cartBubble.classList.toggle('visually-hidden', itemCount === 0 && !showEmptyBubble);
